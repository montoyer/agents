...
- **Salary scales and pension rates change annually** — all figures generated by
  `pmo-pension-specialist` must be tagged `[model knowledge — verify against current
  PMO tables]`; pension projections are indicative only
