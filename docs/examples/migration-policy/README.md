...
```
/college-deliberate "New Pact: mandatory solidarity vs. voluntary solidarity — which model should the Commission propose?"
```
...
```
/council-eu "New Pact — mandatory solidarity: QMV analysis. Which member states form a blocking minority?"
```
...
```
/treaty-check "Accelerated border procedure — is 7-day screening compatible with fundamental rights?"
```
